<?php $__env->startSection('title', 'الأنظمة والقوانين - المستشار القانوني الذكي'); ?>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $laws; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $law): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
        <div class="bg-white p-5 rounded-xl border border-primary/5 shadow-sm hover:border-primary transition-all magnetic-element law-card" data-law-id="<?php echo e($law->id); ?>">
            <div class="flex items-start justify-between gap-3 mb-3">
                <div class="flex items-start gap-3 flex-1 min-w-0">
                    <label class="flex items-center shrink-0 cursor-pointer" onclick="event.stopPropagation()">
                        <input type="checkbox" class="law-checkbox size-5 rounded border-slate-300 text-primary focus:ring-primary focus:ring-offset-0 cursor-pointer" value="<?php echo e($law->id); ?>" onchange="updateBulkDeleteButton()">
                    </label>
                    <a href="<?php echo e(route('laws.show', $law)); ?>" class="flex items-start gap-3 flex-1 min-w-0 hover:opacity-80 transition-opacity">
                        <div class="size-12 rounded-lg bg-primary/10 flex items-center justify-center text-primary shrink-0">
                            <span class="material-symbols-outlined">gavel</span>
                        </div>
                        <div class="flex-1 min-w-0">
                            <h4 class="font-bold text-sm"><?php echo e($law->name); ?></h4>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($law->description): ?>
                                <p class="text-xs text-slate-500 mt-1 line-clamp-2"><?php echo e($law->description); ?></p>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    </a>
                </div>
                <div class="flex items-center gap-1" onclick="event.stopPropagation()">
                    <button onclick="openEditModal(<?php echo e($law->id); ?>, '<?php echo e(addslashes($law->name)); ?>', '<?php echo e(addslashes($law->description ?? '')); ?>', '<?php echo e($law->category ?? ''); ?>')" class="size-8 flex items-center justify-center text-slate-400 hover:text-primary hover:bg-primary/10 rounded-lg transition-colors" title="تعديل">
                        <span class="material-symbols-outlined text-lg">edit</span>
                    </button>
                    <button onclick="confirmDelete(<?php echo e($law->id); ?>, '<?php echo e(addslashes($law->name)); ?>')" class="size-8 flex items-center justify-center text-slate-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition-colors" title="حذف">
            ...
            <div class="flex items-center gap-3 text-xs text-slate-600 mt-3 pt-3 border-t border-slate-100">
                <div class="flex items-center gap-1">
                    ...
                    <span><?php echo e($law->files_count); ?> ملف</span>
                </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($law->isProcessed()): ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($laws->hasPages()): ?>
    <div class="mt-8">
        <?php echo e($laws->links()); ?>
...
<div id="uploadModal" class="hidden fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4">
    <div class="bg-white rounded-2xl max-w-2xl w-full shadow-2xl max-h-[90vh] overflow-y-auto">
        ...
        <form id="uploadLawForm" action="<?php echo e(route('laws.store')); ?>" method="POST" enctype="multipart/form-data" class="p-6 space-y-5">
            <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                    ...
                    placeholder="وصف موجز للقانون ومجال تطبيقه"><?php echo e(old('description')); ?></textarea>
            </div>
...
<div id="bulkDeleteModal" class="hidden fixed inset-0 bg-black/50 flex items-center justify-center z-[70] p-4">
    <div class="bg-white rounded-2xl max-w-md w-full shadow-2xl">
        <div class="p-6">
            ...
            <form id="bulkDeleteForm" method="POST" action="<?php echo e(route('laws.bulk-delete')); ?>">
                <?php echo csrf_field(); ?>
                <?php echo method_field('DELETE'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/pages/laws/index.blade.php ENDPATH**/ ?>